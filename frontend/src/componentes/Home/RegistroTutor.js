    ...
    const formHandleSubmit = (data) => {
        ...
        if (data.password === data.password2) {
            ...
            const registro = async () => {
                const errorUsuario = await crearUsuarioTutor(coleccion);
                if (errorUsuario.response.status != 200)  {
                    const arregloErrores=errorUsuario.response.data
                            ...
                            <Box component="form" noValidate onSubmit={handleSubmit(formHandleSubmit)} sx={{ mt: 1 }}>
                                <Stack direction="column" justifyContent={"left"} alignItems="left" marginTop={2}>
                                    ...
                                    <FormControl>
                                        ...
                                        <FormHelperText sx={{ color: 'red' }}>{valido && "username" in errores? "Ya este correo se encuentra asociado a una cuenta registrada, utlice otro" : ""}</FormHelperText>
                                    </FormControl>
                                    <FormControl>
                                        <TextField
                                            margin="normal"
                                    ...
                                    <FormControl>
                                        ...
                                        <FormHelperText sx={{ color: 'red' }}>{valido && "password" in errores? errores.password[0] : ""}</FormHelperText>
                                    </FormControl>
                                    <Button
                                        type="submit"
                                        fullWidth
